                            ...
                            if ($_SESSION['admin'] == True) {
                                ...
                                <tbody>
                                    ...
                                    while ($data = mysqli_fetch_array($ambildatadokter)) {
                                        ...
                                        // $dataantrian = $data['totalantrian'];
                                        
                                        $queryantrian = mysqli_query($koneksi, "SELECT COUNT(*) totalantrian FROM pendaftaran WHERE id_jadwal_dokter='$ijd'");
                                    ...
                                    ?>
                                        <tr>
                                            ...
                                            <td><?= $jam_jadwal; ?></td>
                                            <td><?= 20 - $dataantrian['totalantrian'] ?? 0; ?></td>
                                            <td>
