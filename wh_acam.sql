...
--
-- Host: 127.0.0.1
-- Generation Time: Jan 23, 2023 at 05:17 PM
...
(1, 'Guntur', '2023-01-23', '14:34:00'),
(2, 'Agung', '2023-01-23', '22:11:00'),
(3, 'Roby', '2023-01-23', '22:12:00');
...
(2, 'Desta', '1234567890123456', 'Yogya', 'Jombor', '2023-01-02', '123'),
(3, 'Vincent', '1234567890123456', 'Yogya', 'Jombor', '2023-01-03', '123');
...
--
ALTER TABLE `data_jadwal_dokter`
  MODIFY `id_jadwal_dokter` int(5) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;
...
--
ALTER TABLE `pendaftaran`
  MODIFY `id_pendaftaran` int(5) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=33;
